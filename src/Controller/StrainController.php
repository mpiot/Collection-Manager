...
class StrainController extends AbstractController
{
    ...
    {
        $results = $this->get('App\Utils\IndexFilter')->filter(Strain::class, true, true, [Group::class]);
     ...
     */
    private function createDeleteForm(Strain $strain): \Symfony\Component\Form\FormInterface
    {
    ...
    public function nameAutocompleteAction($group, $name)
    {
        ...
        $repository = $repositoryManager->getRepository('App:Strain');
