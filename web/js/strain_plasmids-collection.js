$(document).ready(function() {
    ...
    if (0 !== $container.length) {
        ...
        $container.find('div.form-group > label:not([for*=_strain_strainPlasmids_])').text('');
        $container.find('div.form-group > label:not([for*=_strain_strainPlasmids_])').removeClass('required');

        // On ajoute un lien pour ajouter une nouvelle catégorie
        var $addLink = $('<a href="#" id="add_plasmid" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-plus"></span> Add a plasmid</a>');
