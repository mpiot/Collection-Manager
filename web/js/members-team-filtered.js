$(document).ready(function() {
    ...
    var checkAllLink = $('<a href="#" id="check_all_users" > Check all</a>');
    var uncheckAllLink = $('<a href="#" id="uncheck_all_users" > Uncheck all</a>');
    ...
    // Create onClick event on Team
    $( "select[name='project[teams][]']" ).change(function() {
        uncheckAll();
